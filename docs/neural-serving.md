...
当前接入的是四小时训练结束的 780 局检查点，SHA-256 为 `f98f4e2225049f74b4601ca13a2520c32d8a3b250927da17fa9266c06f2c2666`。原模型有 1,275,134 个训练参数，包含两层实体注意力和 128 维 GRU。此部署没有启动新训练，也没有增加 64 层网络。
