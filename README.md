...
| 可玩随从 | 124 种，使用各自的普通与金色数值及技能 |
| 酒馆法术 | 图鉴 67 种，其中 42 种可购买和施放 |
| 英雄 | 22 名，采用当前技能费用、生命值和护甲 |
...
技能引擎支持战吼、亡语、进击、发动、塑造法术、磁力、复生、烈毒、圣盾、嘲讽、风怒、顺劈、回合增益及若干种族成长机制。英雄包括巫妖王、乔治、帕奇维克、疯狂金字塔、米尔菲丝、诺兹多姆、欧穆、奥拉基尔、霍格、荷利戴医生、萨维斯，以及新增的泽瑞拉、雷诺、伊莉斯、阿莱克丝塔萨、布莱克松、因葛、米尔豪斯、齐恩瓦拉、芬利、阮大师和吉恩。
...
本次补入催眠机器人、狂棍野猪人、软泥角斗士、混编战团、竞技表演者、梦魇茶客、胡蒙格斯、赤红守备巨龙、天诞逃生飞龙和合唱鱼人。新增法术包括身份揭晓、新生幼苗、预订遗体、猎头招聘、位面望远镜、友方悬赏令、寒热骤变、自然祝福、点金之触及大地母亲之眼。发现和定向取牌占用有限池，点金保留原份数与额外属性，不发放三连奖励。旧对局继续使用创建时的有限池，新开一局才能抽到新增随从。
