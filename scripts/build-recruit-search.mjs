...
await build({ entryPoints: ['rl/stage-evaluation-bridge.ts'], bundle: true, platform: 'node', target: 'node20',
  format: 'cjs', outfile: 'rl-dist/stage-evaluation.cjs', define: { 'import.meta.env.BASE_URL': '"/tavern/"' }, logLevel: 'info' });
